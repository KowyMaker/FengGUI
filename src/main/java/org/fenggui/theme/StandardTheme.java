...
/**
 * Theme class to define the appearance of the standard widgets (those widgets
 * in <code>org.fenggui</code>). Does not use any context.
 * 
 * @author kjuytr, last edited by $Author: marcmenghin $, $Date: 2009-03-13
...
public abstract class StandardTheme implements ITheme
{
    ...
    public void setUp(IWidget widget)
    {
        ...
        else if (widget instanceof RadioButton)
        {
            ...
            // else if (widget instanceof TabItemLabel) setUp((TabItemLabel)
            // widget);
            // else if (widget instanceof Console) setUp((Console) widget);
            // else if (widget instanceof SnappingSlider) setUp((SnappingSlider)
            // widget);
        }
        else
        {
