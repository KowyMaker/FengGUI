...
public class MissingAttributeException extends IXMLStreamableException
{
     ...
     *            the context in which the attribute should have been found
     * @return an MissingAttributeException with a suitable message
     */
    public static MissingAttributeException createDefault(String attribute,
            IParseContext parsingContext)
    {
