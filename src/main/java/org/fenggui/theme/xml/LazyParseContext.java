 ...
 * representation lazily. This allows us to avoid wasting time on an expensive
 * operation unless it is actually needed.
 */
public class LazyParseContext implements IParseContext
{
    ...
    public String parseContextString()
    {
        ...
        elt.toXML("", eltStr);
        return XMLProcessPointer.getParsingContext(eltStr.toString(),
                eltStartLine, pointerLine);
    }
}
