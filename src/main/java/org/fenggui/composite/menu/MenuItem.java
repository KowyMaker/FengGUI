...
{
    private final ArrayList<IMenuItemPressedListener> menuItemPressedHook = new ArrayList<IMenuItemPressedListener>();
     ...
     */
    public MenuItem(InputOnlyStream stream) throws IOException,
     ...
     * 
     * @param enabled
     *            true if item shall be enabled, false otherwise
     */
    ...
    /**
     * Add a {@link IMenuItemPressedListener} to the widget. The listener can be
     * added only once.
     * 
     * @param l
     *            Listener
    ...
    {
        final MenuItemPressedEvent e = new MenuItemPressedEvent(menu, this);
        
        for (final IMenuItemPressedListener l : menuItemPressedHook)
        {
            l.menuItemPressed(e);
        }
    }
