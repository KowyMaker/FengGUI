...
/**
 * 
 * Open submenus form together a chain. If a menu item is clicked or the menu
 * chain is closed all menus need to be closed. Menu bars can be part of this so
 * that we need an abstraction here. <br/>
 * <br/>
 * Depedinging on where the close event is emitted, we need to follow the chain
 * backwards or forward (according to the order in which the menus were
 * opended).
 * 
 * 
