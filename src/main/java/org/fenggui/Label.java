...
/**
 * Widget for displaying a line of text and/or a pixmap. This widget is passive
 * and does not react on anything.
 * 
 * @author Johannes Schaback aka Schabby, last edited by $Author: marcmenghin $,
 *         $Date: 2007-11-28 11:16:38 +0100 (Mi, 28 Nov 2007) $
...
public class Label extends StandardWidget implements ILabel, Cloneable
{
    ...
    public void setAppearance(LabelAppearance appearance)
    {
        ...
        textData.adaptChange(appearance.getContentWidth(),
                appearance.getContentHeight(), getAppearance());
        updateMinSize();
    }
    ...
    public void paintContent(Graphics g, IOpenGL gl)
    {
        ...
        if (pixmap != null)
        {
            ...
            y = getAppearance().getAlignment().alignY(contentHeight,
                    pixmap.getHeight());
    ...
    public Label clone()
    {
        ...
        result.appearance = new LabelAppearance(result, appearance);
