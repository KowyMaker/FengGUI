...
public class MousePressedEvent extends MouseEvent
{
     ...
     * 
     * @param mouseX
     *            the x coordinate where the click occured
     * @param mouseY
     *            the y coordinate where the click occured
     * @param mouseButton
     *            which mouse button has been pressed
     * @param clickCount
     *            count of immidiate clicks (provided by Java) for determing
     *            double clicks
     */
    public MousePressedEvent(IWidget source, int mouseX, int mouseY,
