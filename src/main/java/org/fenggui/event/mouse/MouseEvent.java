...
/**
 * Base class for mouse events. It serves to make method naming in mouse event
 * classes consistent and to provide two covenience methods used for translating
 * the mouse coordinates from global display coordinates to widgets coordinates.
 * 
...
public abstract class MouseEvent extends WidgetEvent
{
    ...
    /**
     * Returns the x coordinate of the mouse in the <code>Display</code>
     * coordinate system.
     * 
     * @return x coordinate
     */
    ...
    /**
     * Returns the y coordinate of the mouse in the <code>Display</code>
     * coordinate system.
     * 
     * @return y coordinate
     */
    ...
    /**
     * Returns the x coordinate of the mouse in the coordinate system of the
     * given widget.
     * 
     * @param w
     *            the widget
    ...
    /**
     * Returns the y coordinate of the mouse in the coordinate system of the
     * given widget.
     * 
     * @param w
     *            the widget
