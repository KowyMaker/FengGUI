...
/**
 * 
 * Event type used when the user dragged the mouse of a Widget.
 * 
...
public class MouseDraggedEvent extends MouseEvent
{
    ...
    public MouseDraggedEvent(IWidget source, int x, int y,
            MouseButton mouseButton, Set<Key> modifiers)
    {
