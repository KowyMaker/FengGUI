...
public class FormAttachment
{
    ...
    public FormAttachment(Widget w, int offset)
    {
        ...
        if (attachedWidget == null)
        {
            ...
            System.err
                    .println("FormAttachment Constructor Warning: The Widget you were trying to attach to is null!");
            System.err
                    .println("This leads to unexepected behavior in the FormLayout.");
            System.err
                    .println("Make sure you attach Widgets that are both initiated!");
        }
        this.offset = offset;
    }
     ...
     * 
     * @param numerator
     *            position in percent according the container size in which the
     *            layouted Widget lays.
     * @param offset
     */
