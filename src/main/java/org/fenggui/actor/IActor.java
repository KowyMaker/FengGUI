...
public interface IActor
{
    ...
    /**
     * Assigns the actor to a widget. Normally an actor will hook into the
     * events of an widget and perform some action as they fire.
     * 
     * <p>
     ...
     * 
     * @param widget
     *            the widget the actor should be assigned to.
     */
