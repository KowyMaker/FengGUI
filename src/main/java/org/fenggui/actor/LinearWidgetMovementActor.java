...
public class LinearWidgetMovementActor implements IActor
{
    ...
    private final Point          movementSpeed = null;
    ...
    public LinearWidgetMovementActor(Point endPosition, Point speed)
    {
        ...
        listener = new IEventListener() {
            ...
            public void processEvent(Event event)
            {
                ...
                {
                    final TickEvent te = (TickEvent) event;
    ...
    public void hook(IWidget widget)
    {
        ...
        if (this.display != null && this.display != display)
        {
            throw new IllegalArgumentException(
                    "Widget needs to be on same display");
        }
        else
        {
            if (display == null)
            {
                throw new IllegalArgumentException(
                        "Widget needs to be in the widgettree.");
            }
    ...
    public void unHook(IWidget widget)
    {
        if (display != null)
        {
            ...
            {
                throw new IllegalArgumentException(
                        "needs to be the hooked widget.");
            }
        }
        else
        {
            throw new IllegalStateException(
                    "first you need to hook onto a widget.");
        }
    }
