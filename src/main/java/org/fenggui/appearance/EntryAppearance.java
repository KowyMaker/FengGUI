...
public class EntryAppearance extends LabelAppearance
{
    ...
    public EntryAppearance(StandardWidget w, InputOnlyStream stream)
    ...
    {
        super(w, appearance);
        hoverColor = new Color(appearance.hoverColor);
        selectionColor = new Color(appearance.selectionColor);
        color = new Color(appearance.color);
        rowHeight = appearance.getRowHeight();
        selectionUnderlay = new DecoratorLayer(
                appearance.getSelectionUnderlay());
        mouseHoverUnderlay = new DecoratorLayer(appearance.getHoverUnderlay());
    }
            ...
            IXMLStreamableException
    {
        ...
        selectionColor = stream.processChild("SelectionColor", selectionColor,
                Color.BLACK, Color.class);
        hoverColor = stream.processChild("HoverColor", hoverColor, Color.BLACK,
                Color.class);
        color = stream.processChild("Color", color, Color.BLACK, Color.class);
        
        selectionUnderlay = stream.processChild("SelectionUnderlay",
                selectionUnderlay, new DecoratorLayer(), DecoratorLayer.class);
        mouseHoverUnderlay = stream.processChild("HoverUnderlay",
                mouseHoverUnderlay, new DecoratorLayer(), DecoratorLayer.class);
    ...
    public LabelAppearance clone(StandardWidget widget)
    {
        ...
        result.hoverColor = hoverColor.clone();
        result.selectionColor = selectionColor.clone();
