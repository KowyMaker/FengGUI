...
public abstract class GenericAppearance extends DecoratorAppearance
{
    ...
    class IntegerStore implements IXMLStreamable
    {
        ...
        public IntegerStore clone()
        {
            ...
            result.value = new Integer(value.intValue());
            return result;
        }
    }
     ...
     */
    public GenericAppearance(StandardWidget w, InputOnlyStream stream)
    ...
    public Integer getInteger(String key)
    {
        ...
        {
            final IntegerStore store = integers.get(key);
            if (store != null)
            {
    ...
    protected DecoratorAppearance clone(StandardWidget widget)
    {
        ...
        if (alignments != null)
        {
            result.alignments = new HashMap<String, Alignment>(
                    alignments.size());
            for (final Entry<String, Alignment> align : alignments.entrySet())
            {
        ...
        if (decorators != null)
        {
            result.decorators = new HashMap<String, IDecorator>(
                    decorators.size());
            for (final Entry<String, IDecorator> align : decorators.entrySet())
            {
        ...
        if (spacings != null)
        {
            result.spacings = new HashMap<String, Spacing>(spacings.size());
            for (final Entry<String, Spacing> align : spacings.entrySet())
            {
        ...
        if (colors != null)
        {
            result.colors = new HashMap<String, Color>(colors.size());
            for (final Entry<String, Color> align : colors.entrySet())
            {
        ...
        if (integers != null)
        {
            result.integers = new HashMap<String, IntegerStore>(integers.size());
            for (final Entry<String, IntegerStore> align : integers.entrySet())
            {
        ...
        if (pixmaps != null)
        {
            result.pixmaps = new HashMap<String, Pixmap>(pixmaps.size());
            for (final Entry<String, Pixmap> align : pixmaps.entrySet())
            {
