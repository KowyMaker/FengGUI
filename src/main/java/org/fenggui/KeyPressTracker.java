...
/**
 * Instance of this class tracks states of modifier keys by listening
 * keyup/keydown listeners. Its purpose is to provide (stupid) mechanism which
 * will at any time know if some key is pressed or not.
 * 
...
public class KeyPressTracker
{
    ...
    {
        // TODO Expensive. Some other way to prevent accessors from modifying
        // original set?
        // return new HashSet<Key>(modifiers);
        // Maybe this is not even a bad thing. I would say that if he wants to
        // change it its bad that he can't.
        return modifiers;
    }
}
