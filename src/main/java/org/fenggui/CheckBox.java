...
/**
 * Implementation of a check box. A check box can be used to toggle between two
 * states. <br/>
 * <br/>
 ...
 */
public class CheckBox<E> extends ObservableLabelWidget implements
        IToggable<CheckBox<E>>
{
    ...
    public void keyTyped(KeyTypedEvent keyTypedEvent)
    {
        if (keyTypedEvent.getKeyClass() == Key.ENTER
                || Character.isSpaceChar(keyTypedEvent.getKey()))
        {
    ...
    /**
     * Add a {@link ISelectionChangedListener} to the widget. The listener can
     * be added only once.
     * 
     * @param l
     *            Listener
     ...
     * @param s
     */
    private void fireSelectionChangedEvent(IWidget source, CheckBox<E> t,
            boolean s)
    {
