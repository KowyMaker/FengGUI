...
public class BevelBorder extends Border
{
    ...
    /**
     * Creates a new <code>BevelBorder</code> object. The spacing is set to 1
     * per default.
     * 
     */
    public BevelBorder()
     ...
     * 
     * @param elevated
     *            the color of the ascending edges
     * @param lowered
     *            the color of the descending edges
     */
    ...
    public void paint(Graphics g, int localX, int localY, int width, int height)
    {
        ...
        if (getBottom() > 0)
        {
            ...
            gl.vertex(globalX - getLeft() + width + getRight(), globalY
                    + getBottom() / 2);
        }
        ...
        if (getRight() > 0)
        {
            ...
            gl.vertex(globalX - getLeft() + width + getRight() / 2, globalY
                    + getBottom());
            gl.vertex(globalX - getLeft() + width + getRight() / 2, globalY
                    - getBottom() + height);
        }
