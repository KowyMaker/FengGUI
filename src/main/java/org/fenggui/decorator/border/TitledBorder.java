 ...
 *         2009-04-25 11:54:13 +0200 (Sa, 25 Apr 2009) $
...
public class TitledBorder extends Border
{
    ...
    public void paint(Graphics g, int localX, int localY, int width, int height)
    {
        ...
        final int OFFSET = 2;
        final int halfFontSize = font.getHeight() / 2;
        final int topPosY = localY + height - halfFontSize - OFFSET;
        ...
        // right
        g.drawLine(localX + width - getRight(), localY, localX + width
                - getRight(), topPosY);
        
        // top
        g.drawLine(localX, topPosY, localX + 5, topPosY);
        
        g.drawLine(localX + font.getWidth(title) + 15, topPosY, localX
                + getLeft() + width, topPosY);
