 ...
 * 
 * @todo Calculate interpolation for colors. Dont use stactic Color array.
 *       Rather, calc Color values from angle and position. Urgent. The whole
 *       index thing is just a adhoc solution.... #
 */
public class GradientBackground extends Background
{
     ...
     * 
     * @param top
     *            color of the two upper corners.
     * @param bottom
     *            color of the two lower corners.
     */
    ...
    public GradientBackground(InputOnlyStream stream) throws IOException,
     ...
     * 
     * @param lowerLeft
     *            color of lower right corner
     * @param lowerRight
     *            color of lower left corner
     * @param upperRight
     *            color of upper right corner
     * @param upperLeft
     *            color of upper left corner
     */
    public GradientBackground(Color lowerLeft, Color lowerRight,
            Color upperRight, Color upperLeft)
    {
            ...
            IXMLStreamableException
    {
        ...
        upperRight = stream.processChild("TopRightColor", upperRight,
                Color.class);
        lowerLeft = stream.processChild("BottomLeftColor", lowerLeft,
                Color.class);
        lowerRight = stream.processChild("BottomRightColor", lowerRight,
                Color.class);
    }
