...
/**
 * Basic class for all backgrounds. Its purpose is mainly to provide the
 * <code>paint</code> method which will be overriden by specific background
 * implementations.
 * 
 * <br/>
...
public abstract class Background extends Decorator
{
    ...
    /**
     * Every Background class must register itself to the type register if it
     * should be possible to be loaded using InputOutputStream
     */
