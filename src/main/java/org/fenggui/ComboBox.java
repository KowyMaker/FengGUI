 ...
 * 
 * @author Johannes, last edited by $Author: marcmenghin $, $Date: 2008-01-25
 *         15:58:55 +0100 (Fr, 25 Jan 2008) $
 * @version $Revision: 606 $
 */
public class ComboBox extends StatefullWidget<DefaultAppearance> implements
        IBasicContainer
{
    ...
    public ComboBox(InputOnlyStream stream) throws IOException,
    ...
    private void setupWidget()
    {
        ...
        addSelectionChangedListener(new ISelectionChangedListener() {
            ...
            public void selectionChanged(SelectionChangedEvent e)
            {
                ...
                final Item item = list.getSelectedItem();
    ...
    /**
     * Returns the popup list that appears when the user clicks on the combo
     * box.
     * 
     * @return popup list
     */
    ...
    public void layout()
    {
        ...
        final int width = getAppearance().getContentWidth();
    ...
    {
        for (final Item item : list.getItems())
        {
    ...
    private void openPopup()
    {
        ...
        popupContainer.setWidth(Math.max(list.getWidth(), getWidth())
                + horMargins);
    ...
    public void keyReleased(KeyReleasedEvent keyReleasedEvent)
    {
        if (!keyReleasedEvent.isAlreadyUsed()
                && (keyReleasedEvent.getKeyClass() == Key.ENTER || keyReleasedEvent
                        .getKey() == ' '))
        {
            ...
            IXMLStreamableException
    {
        ...
        setPixmap(stream
                .processChild("Pixmap", getPixmap(), null, Pixmap.class));
    }
    ...
    public Dimension getMinContentSize()
    {
        ...
        final Dimension d = new Dimension(list.getAppearance()
                .getContentMinWidth() + pixmapWidth, Math.max(
                label.getMinHeight(), pixmapHeight));
        
        // why is this here?
        // if (popupContainer != null && popupContainer.getMinWidth() >
        // d.getWidth())
    ...
    public void paintContent(Graphics g, IOpenGL gl)
    {
        ...
        if (pixmap != null)
        {
            ...
            g.drawImage(
                    pixmap,
                    getAppearance().getContentWidth() - pixmap.getWidth(),
