 ...
 */
public class ObservableLabelWidget extends StatefullWidget<LabelAppearance>
        implements ILabel, Cloneable
{
            ...
            IXMLStreamableException
    {
        ...
        textData.setContent(
                stream.processAttribute("text", textData.getContent(), ""),
                getAppearance());
    ...
    public ObservableLabelWidget clone()
    {
        ...
        final LabelAppearance app = this.getAppearance().clone(result);
