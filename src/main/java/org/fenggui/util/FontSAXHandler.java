...
public class FontSAXHandler extends DefaultHandler
{
            ...
            throws SAXException
    {
        if (qName.equals("character"))
        {
            ...
            if (s.length() > 1)
            {
                throw new SAXException(
                        "The <character> element holds a string that contains more than one character!");
            }
        ...
        {
            final CharacterPixmap cp = new CharacterPixmap(null, x, y, width,
                    height, character, charWidth);
