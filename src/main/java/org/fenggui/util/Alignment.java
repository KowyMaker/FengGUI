...
public enum Alignment
{
     ...
     * working on a screen, we will assume that the point is a 1x1 sized element
     * in order to get top and right alignments looking correctly on screen.
     * 
     * @param origin
