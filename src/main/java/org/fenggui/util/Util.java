...
public final class Util
{
    ...
    /**
     * Tries to create a instance of the given class over an empty constructor.
     * Returns null if it didn't find such a constructor of if it couldn't
     * create a instance over it.
     * 
     * @param <T>
     * @param objClass
     * @return
    ...
    public static <T> T createInstanceOfClass(Class<T> objClass)
    {
        ...
        try
        {
            final Constructor<T> con = objClass.getConstructor();
            obj = con.newInstance();
        }
