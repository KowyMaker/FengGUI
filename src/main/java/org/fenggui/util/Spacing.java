 ...
 * 
 * 
 * Box has to catch if the spacing is changing (setBorder, setPadding,
 * setMargin) thus you have to create a new instance for a new spacing and use
...
public class Spacing implements IXMLStreamable, Cloneable
{
    ...
    public Spacing(InputOnlyStream stream) throws IOException,
    ...
    public void process(InputOutputStream stream) throws IOException,
            IXMLStreamableException
    {
        if (!stream.isInputStream() && top == left && left == right
                && right == bottom)
        {
