...
{
    private final ArrayList<RenderStage> stages = new ArrayList<RenderStage>();
    
    public void execute(FontMetrics fontMetrics, BufferedImage image, char c,
            int safetyMargin)
    {
        
        for (final RenderStage stage : stages)
        {
