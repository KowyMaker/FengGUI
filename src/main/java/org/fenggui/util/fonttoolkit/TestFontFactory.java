...
public class TestFontFactory
{
    ...
    public static void main(String[] args)
    {
        ...
        final FontFactory ff = new FontFactory(Alphabet.getDefaultAlphabet(),
                font);
        final AssemblyLine line = ff.getAssemblyLine();
        
        final Paint redYellowPaint = new GradientPaint(0, 0, Color.RED, 15, 15,
                Color.YELLOW, true);
        final Paint greenWhitePaint = new GradientPaint(0, 0, Color.BLACK, 15,
                0, Color.GREEN, true);
        ...
        // ff.addRenderer(new Convolution(Kernel.createGaussianKernel(3, 1.5),
        // true));
        ...
        // ff.addRenderer(new Convolution(Kernel.createGaussianKernel(3, 1.4),
        // true));
