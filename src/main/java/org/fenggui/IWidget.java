...
/**
 * A IWidget interface provides a definition for objects that represent a
 * Widget. A Widget is the most basic entity of a GUI system. It is defined as a
 * entity with a rectangular area.
 * 
 * The minimum size of a widget is maintained by the widget itself and is always
 * kept up to date, while the actual size of the widget is usually set by the
 * layout manager. Alternatively, one can set the actual size of a widget
...
public interface IWidget extends IXMLStreamable
{
    ...
    /**
     * Returns the layout data associated with this widget. LayoutManagers will
     * use this data to correctly layout the widget within the container.
     * 
     * @return Data the LayoutManager of the parent Container will use or
     *         <code>null</code> if none.
     */
    public ILayoutData getLayoutData();
    
    /**
     * Returns the parent container if there is one. Else it will return
     * <code>null</code>. On the Display class this will always return
     * <code>null</code>.
     * 
     ...
     * only the Widget will be cloned not its content.
     * 
     ...
     * 
     * <p>
     * Note: This event will travel from the hovered widget to the root of the
     * visual tree (usually the Display object).
     * </p>
     * 
    ...
    /**
     * Called on the hovered widget when the mouse pointer moves over the
     * widget. Do not make computationally expensive things here because this
     ...
     * 
     *       <p>
     *       Note: This event will travel from the hovered widget to the root of
     *       the visual tree (usually the Display object).
     *       </p>
     * 
     * @param displayX
    ...
    /**
     * Called on the hovered widget when the mouse is dragged (moved while
     * pressing a mouse button down) over the Widget.
     * 
     * <p>
     * Note: This event will travel from the hovered widget to the root of the
     * visual tree (usually the Display object).
     * </p>
     * 
     * @todo mouseDragged is actually only a special case of mouseMoved.
    ...
    /**
     * Called on the hovered widget when a previously pressed mouse button is
     * released on the Widget. It can not be expected that the mouse button was
    ...
    /**
     * Called on the hovered widget when the user clicks one something. This
     * event is raised after a mousePressed and before a mouseReleased event
     * occurs.
     * 
     * <p>
     * Note: This event will travel from the hovered widget to the root of the
    ...
    /**
     * Called on the hovered widget when the mouse button is pressed twice in a
     * short time.
     * 
     * <p>
     * Note: This event will travel from the hovered widget to the root of the
     ...
     * 
     * <p>
     * Note: This event will travel from the focused widget to the root of the
     * visual tree (usually the Display object).
     * </p>
     * 
    ...
    /**
     * Called on the focused widget when a previously pressed key on the
    ...
    /**
     * Called on the focused widget when a key is Typed. This event is raised
     * after a keyPressed event and before a keyReleased event.
     * 
     * <p>
     * Note: This event will travel from the focused widget to the root of the
     * visual tree (usually the Display object).
    ...
    /**
     * Returns the Display the Widget is in or <code>null</code> if its not
     * added to any Display.
     * 
     * @return
     */
    ...
    /**
     * Returns the widget that is on the given location or <code>null</code> if
     * none is found.
     * 
     * @param x
     *            local x value
    ...
    /**
     * Updates the minSize of the widget. Usually this should be handled by the
     * Widgets themself.
     */
    ...
    /**
     * This is called if the widget is added to the widget Tree. This indicated
     * that calls to getDisplay() should from now on not return null but the
     * Display object.
     */
    ...
    /**
     * Set a custom data object to the widget. This is a method to associate
     * arbitrary data with a specific widget.
     * 
     * @param data
     *            the data object
