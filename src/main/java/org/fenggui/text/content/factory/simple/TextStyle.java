...
public class TextStyle implements IXMLStreamable, Cloneable
{
    ...
    private final Map<String, TextStyleEntry> styles          = new HashMap<String, TextStyleEntry>();
   ...
   */
    ...
    public TextStyle(InputOnlyStream stream) throws IOException,
    ...
    public TextStyle clone()
    {
        ...
        for (final Entry<String, TextStyleEntry> entry : styles.entrySet())
        {
