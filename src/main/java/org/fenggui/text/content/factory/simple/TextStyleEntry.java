...
public class TextStyleEntry implements IXMLStreamable, Cloneable
{
    ...
    public TextStyleEntry(InputOnlyStream stream) throws IOException,
    ...
    public void process(InputOutputStream stream) throws IOException,
            IXMLStreamableException
    {
        fontStyle = stream.processAttribute("fontstyle", fontStyle,
                ITextRenderer.DEFAULTTEXTRENDERERKEY);
        background = stream.processChild("Background", background,
                new DecoratorLayer(), DecoratorLayer.class);
        selectionBackground = stream
                .processChild("SelectionBackground", selectionBackground,
                        new DecoratorLayer(), DecoratorLayer.class);
    ...
    public TextStyleEntry clone()
    {
        ...
        result.background = background.clone();
        result.selectionBackground = selectionBackground.clone();
