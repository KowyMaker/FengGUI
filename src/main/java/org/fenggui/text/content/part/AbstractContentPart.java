...
public abstract class AbstractContentPart
{
    ...
    public AbstractContentPart(int beforeLength, int afterLength,
            String styleKey)
    {
    ...
    /**
     * Returns True if the content of this Part is breakable. Normally this is
     * true if the AtomCount is greater than one.
     * 
     * @return
     */
    ...
    /**
     * Breaks a part into two parts. It fill the max. words into the remaining
     * part. The returned part is everything that didn't fit into the given
     * width. If it is a firstPart and no word fits into the width it will split
     * the first word on the character level.
     * 
     * @param width
     ...
     */
    public abstract AbstractContentPart splitAtWord(int width,
            boolean onlyPart, TextAppearance appearance);
    
    /**
     * Breaks a part into two parts. It fill the max. atoms into the remaining
     * part. The returned part is everything that didn't fit into the given
     * width.
     * 
     * @param width
    ...
    /**
     * Breaks the part into two parts. It fills the max. atoms into the
     * remaining part. The returned part is everything after the given atom.
     * 
     * @param atom
     *            atom to cut after
     ...
     * @return Returns everything after the given atom.
     */
    public abstract AbstractContentPart splittAtActivePosition(
            TextAppearance appearance);
    ...
    /**
     * if this returns true then this part can be removed if an other part is at
     * the same line. True means that this part is empty and will not display
     * anything.
     * 
     * @return
     */
    ...
    /**
     * Returns the position of the currently selected atom. Essentially it is a
     * call to getAtomPosition with the current selected atom as parameter.
     * 
     * @return
     */
    ...
    /**
     * Adds new content to this part. Usually this is used for pasting content
     * and similar things.
     * 
     * @param content
     *            content to add.
    ...
    /**
     * Returns true if the given character is valid within this content part,
     * false otherwise.
     * 
     * @param character
     * @param appearance
     * @return
     */
    public abstract boolean isValidCharacter(char character,
            TextAppearance appearance);
    
    /**
     * Returns the content of this contentPart in a reproducible form. Creating
     * a new content part with this String should result in the same content
     * being displayed.
     * 
     * @return
     */
