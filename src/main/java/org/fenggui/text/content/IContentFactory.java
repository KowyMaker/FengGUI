...
/**
 * Factory which is responsible to map from the content to a displayable
 * structure using ContentParts. It is used by the AdvancedTextRenderer system.
 * 
...
public interface IContentFactory
{
    ...
    /**
     * Splits the given content into its lines. The resulting list container for
     * each line the object representing this line. No auto word-warping
     * applied.
     * 
     * @param content
     * @return
    ...
    /**
     * This method is used to transform special objects like images into the
     * representing content format.
     * 
     * @param obj
     * @return
     */
