...
/**
 * This stores the data a ComplexTextRenderer needs. Normally this object will
 * hold the Text, Colors and TextRenderers that are used. In most cases it will
 * only be usable with one specific complex TextRenderer.
 * 
...
{
    /**
     * Sets the text that will be used. This text may be transformed depending
    ...
    /**
     * Sets if the text should only be used till the first linebreak. If false
     * all text after the linebreak will be removed. If this is false,
     * word-warping still can be used.
     * 
     * @param multiline
     */
    ...
    /**
     * If true, text that is too long for a line will automatically be put on
     * the next line.
     * 
    ...
    /**
     * Sets that too long text should be put to the next line. This also works
     * if multiline is set to false.
     * 
     * @param warp
     *            if true all text that is too long for one line will be split
     *            so it fits into the line.
     */
    public void setWordWarping(boolean warp, TextAppearance appearance);
    
    /**
     * Should be called if the widget is resized or something on the appearance
     * changes. This will update the content to correctly reflect the changes.
     * 
     * @param width
