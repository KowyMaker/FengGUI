...
/**
 * Implementation of a radio button which usually represents a single option out
 * of a set of options where only one option can be selected.
 * 
 * 
 * @author Johannes Schaback, last edited by $Author: marcmenghin $, $Date:
 *         2008-01-21 14:05:20 +0100 (Mo, 21 Jan 2008) $
 * @version $Revision: 614 $
 */
public class RadioButton<E> extends ObservableLabelWidget implements
        IToggable<RadioButton<E>>
{
    ...
    public RadioButton(InputOnlyStream stream) throws IOException,
    ...
    public void keyPressed(KeyPressedEvent keyPressedEvent)
    {
        if (keyPressedEvent.getKeyClass() == Key.ENTER
                || Character.isSpaceChar(keyPressedEvent.getKey()))
        {
            setSelected(true);
        }
    ...
    {
        final SelectionChangedEvent e = new SelectionChangedEvent(this, this, b);
    ...
    public void setRadioButtonGroup(
            ToggableGroup<RadioButton<E>> radioButtonGroup)
    {
