 ...
 * 
 * $Id: EventBinding.java 606 2009-03-13 14:56:05Z marcmenghin $
 */
 ...
 * 
 * Note that the mouse event methods in Display return a boolean whether the
 * mouse click hit a GUI component or not. If you need this information, you
 * need to implement this mapping on your own.
 * 
 * @see org.fenggui.Display
 * @author Johannes Schaback
 */
public class EventBinding implements KeyListener, MouseMotionListener,
        MouseListener, MouseWheelListener
{
    ...
    public void keyPressed(KeyEvent e)
    {
        ...
        display.fireKeyPressedEvent(keyChar, EventHelper.getKeyPressed(e));
    }
    ...
    public void keyReleased(KeyEvent e)
    {
        ...
        display.fireKeyReleasedEvent(keyChar, EventHelper.getKeyPressed(e));
    }
    ...
    public void mouseClicked(MouseEvent e)
    {
        ...
        {
            display.fireMouseDoubleClickEvent(e.getX(),
                    display.getHeight() - e.getY(),
                    EventHelper.getMouseButton(e), e.getClickCount() / 2);
        }
        else
        {
            display.fireMouseClickEvent(e.getX(),
                    display.getHeight() - e.getY(),
                    EventHelper.getMouseButton(e), e.getClickCount());
        }
    ...
    public void mouseReleased(MouseEvent e)
    {
        display.fireMouseReleasedEvent(e.getX(),
                display.getHeight() - e.getY(), EventHelper.getMouseButton(e),
                e.getClickCount());
    }
