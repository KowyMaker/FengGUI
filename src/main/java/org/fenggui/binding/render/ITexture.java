 ...
 * is an interface because different OpengGL bindings need to implement it.
 * 
...
public interface ITexture extends IXMLStreamable, IDisposable
{
    ...
    // -->> never used anywhere
    // Also why is this here anyway? In my opinion is this not the
    // responsibility of this class.
    // public void texSubImage2D(int xOffset, int yOffset, int width, int
    // height, ByteBuffer buffer);
}
