...
/**
 * Contains a sub set of the OpenGL functions which are required to set up the
 * GUI. This class is an ad hoc class and conceptual not realy convincing. We
 * should find a better way to provide these few OpenGL methods....
 * 
