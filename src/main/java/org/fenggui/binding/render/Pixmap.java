...
/**
 * A pixmap describes a rectangular area on a texture. The idea behind it is
 * that multiple pixmaps can share the same texture to make the use of texture
 * space more efficient. A pixmap can also span over the whole texture of
 * course.<br/>
 * <br/>
 * Note thate in contrast to the widget space, the origin of a pixmap is at the
 * upper left corner! That makes it easier to define pixmaps on textures,
 * because the textures are usually created with external tools which regard the
...
public class Pixmap implements IXMLStreamable
{
    ...
    /**
     * Creates a new Pixmap that covers the complete image that is hold in the
     * texture.
     * 
     * @param tex
     *            the texture
    ...
    public Pixmap(InputOnlyStream stream) throws IOException,
     ...
     *            the text
     * @param x
     *            the x coordinate of the origin of the Pixmap in the Texture
     * @param y
     *            the y coordinate of the origin of the Pixmap in the Texture
     * @param width
    ...
    /**
     * Returns the x coordinate of the right hand side of the pixmap in texture
     * coordinates
     * 
    ...
    /**
     * Returns the y coordinate of the top of the pixmap in texture coordinates
     * 
            ...
            IXMLStreamableException
    {
        ...
        {
            texture = stream.processChild(texture, XMLTheme.TYPE_REGISTRY);
        }
