...
/**
 * Widget to run custom OpenGL commands in. Set the <code>PaintListener</code>
 * im Appearance Adapter to run you own code. You can modify the projection
 * matrix and model matrix as much as you want.
 * 
 * 
...
public class ViewPort extends Widget
{
    ...
    public void paint(Graphics g)
    {
        ...
        final int viewPortWidth = getWidth();
        final int viewPortHeight = getHeight();
        
        opengl.setViewPort(g.getTranslation().getX(),
                g.getTranslation().getY(), viewPortWidth, viewPortHeight);
